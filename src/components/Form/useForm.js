...
export const useForm = (config) => {
  ...
  return {
    mode, fields, setFields, attachments, screenshotRef, selectedStep, handleNextStep,
    layout, agreed, handleAgreed, location, setLocation, handleScreenshotSet, loading, status,
    approve, id, submit, success, handleSubmittedModalClosed, handleFieldsUpdated, handleStepperChanged
  }
}