function StreetNameRules() {
  return (
    <ol>
      ...
      <li>Punctuation is not allowed e.g. periods, hyphens, apostrophes</li>
      ...
      <li>
        Limit name to 20 characters in length (including spaces), due to
        sign-space limitations Every road planned must be named.
      </li>
    </ol>
  );
}
